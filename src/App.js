      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-2">
            {companies.map(c => <Company name={c.name} revenue={c.revenue} key={Math.random()} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            {companies.map(c =>
              <Company name={this.upperCase(c.name)} revenue={c.revenue} key={Math.random()} />)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-6">
            {this.state.companies.map(c => <Company name={c.name} revenue={c.revenue} key={Math.random()} />)}
          </div>
        </div>
